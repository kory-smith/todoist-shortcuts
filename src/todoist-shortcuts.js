...
(function() {
  ...
  function openCurrentProjectMoreMenu() {
    ...
    const currentProject = selectUnique(
        document, '#left-menu-projects-panel li', (project) => {
          ...
          // we want to skip it.
          return Boolean(link && link.href.endsWith(currentPath))
        });
    if (!currentProject) {
  ...
  */
  ...
  // eslint-disable-next-line max-len
  const ADD_ABOVE_SVG_PATH = 'M9 6.74L6.35 9.4a.5.5 0 01-.7-.7l3.53-3.54a.5.5 0 01.7 0l3.55 3.53a.5.5 0 01-.71.7L10 6.69V18.5a.5.5 0 11-1 0V6.74zM17 15h2.5a.5.5 0 110 1H17v2.5a.5.5 0 11-1 0V16h-2.5a.5.5 0 110-1H16v-2.5a.5.5 0 111 0V15z';

  // eslint-disable-next-line max-len
  const ADD_BELOW_SVG_PATH = 'M9 17.26L6.35 14.6a.5.5 0 00-.7.7l3.53 3.54a.5.5 0 00.7 0l3.55-3.53a.5.5 0 00-.71-.7L10 17.31V5.5a.5.5 0 10-1 0v11.76zM17 9h2.5a.5.5 0 100-1H17V5.5a.5.5 0 10-1 0V8h-2.5a.5.5 0 100 1H16v2.5a.5.5 0 101 0V9z';
